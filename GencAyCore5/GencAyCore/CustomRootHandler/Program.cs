...
app.UseEndpoints(endpoints =>
{
    // Linke statik image kelimesinden sonra / gelen resim adýný Endpointten okicak 
    // eðer gelecek olan bir  istenilen boyut yapýsý varsa bunu QueryStringten okuyabiliriz.
